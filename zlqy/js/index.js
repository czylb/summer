...
function big(value) {//放大函数
    ...
    if(value != null) {
        inner.style.width = width *1.01 + 'px'; 
        inner.style.height = height*1.01 + 'px';
    }
}
...
function shown (some) {
    switch(some) {
        ...
        case 12 :biaoti.innerHTML = "三教" , pa.innerHTML = "国旗飘扬在前，雏鸟啼鸣在侧，鸟语花香，读书之地，波光潋滟，奋斗之初，这里有“三国”，有学子，有故事，最自豪的，便是在清晨看着缓缓升起的国旗，耳边不断传送着国歌。"; break;
        case 13 :biaoti.innerHTML = "四教" , pa.innerHTML = "大一的时候，这里有咱们重邮人每周必去的“英语一条街”。这栋拥有着年代感的第四教学楼，也是我们梦想的聚集地。"; break;
        case 14 :biaoti.innerHTML = "老操" , pa.innerHTML = "不管秋冬还是春夏，不管刮风还是下雨，不管日升还是日落，重邮人总是奔跑在这儿，坚信自己的梦想风向标就在前方。"; break;
        case 15 :biaoti.innerHTML = "数图" , pa.innerHTML = "在这里，有最全面的数字信息，有最前端的科技资讯，有最开阔的“互联网+”平台。"; break;
    }
